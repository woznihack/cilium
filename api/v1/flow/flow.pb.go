...
// Taken from https://github.com/cilium/cilium/blob/b3adc4d9410c76db934df021f99acaa033adf50f/pkg/monitor/api/drop.go#L27-L86
type DropReason int32

const (
	// non-drop reasons
	DropReason_SUCCESS                                    DropReason = 0
	DropReason_INVALID_PACKET                             DropReason = 2
	DropReason_INTERFACE                                  DropReason = 3
	DropReason_INTERFACE_DECRYPTED                        DropReason = 4
	DropReason_LB_SOCK_CGROUP_NO_BACKEND_SLOT_ENTRY_FOUND DropReason = 5
	DropReason_LB_SOCK_CGROUP_NO_BACKEND_ENTRY_FOUND      DropReason = 6
	DropReason_LB_SOCK_CGROUP_REVERSE_ENTRY_UPDATE_FAILED DropReason = 7
	DropReason_LB_SOCK_CGROUP_REVERSE_ENTRY_STALE         DropReason = 8
	// drop reasons
...
var (
	DropReason_name = map[int32]string{
		...
		2:   "INVALID_PACKET",
		3:   "INTERFACE",
		4:   "INTERFACE_DECRYPTED",
		5:   "LB_SOCK_CGROUP_NO_BACKEND_SLOT_ENTRY_FOUND",
		6:   "LB_SOCK_CGROUP_NO_BACKEND_ENTRY_FOUND",
		7:   "LB_SOCK_CGROUP_REVERSE_ENTRY_UPDATE_FAILED",
		8:   "LB_SOCK_CGROUP_REVERSE_ENTRY_STALE",
	...
	DropReason_value = map[string]int32{
		...
		"INVALID_PACKET":      2,
		"INTERFACE":           3,
		"INTERFACE_DECRYPTED": 4,
		"LB_SOCK_CGROUP_NO_BACKEND_SLOT_ENTRY_FOUND":            5,
		"LB_SOCK_CGROUP_NO_BACKEND_ENTRY_FOUND":                 6,
		"LB_SOCK_CGROUP_REVERSE_ENTRY_UPDATE_FAILED":            7,
		"LB_SOCK_CGROUP_REVERSE_ENTRY_STALE":                    8,
...
var file_flow_flow_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x07, 0x0a, 0x04, 0x46, 0x6c, 0x6f,
	...
	0x77, 0x2e, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x37, 0x52, 0x02, 0x6c, 0x37, 0x12, 0x14, 0x0a, 0x05,
	0x72, 0x65, 0x70, 0x6c, 0x79, 0x18, 0x10, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x72, 0x65, 0x70,
	...
	,
	...
	0x62, 0x65, 0x6c, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22,
	0x77, 0x0a, 0x03, 0x54, 0x43, 0x50, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x72, 0x74, 0x12, 0x24, 0x0a, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0e, 0x2e, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x54, 0x43, 0x50, 0x46, 0x6c, 0x61, 0x67,
	0x73, 0x52, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x22, 0x8b, 0x01, 0x0a, 0x02, 0x49, 0x50, 0x12,
	...
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x22, 0x30, 0x0a, 0x06,
	0x49, 0x43, 0x4d, 0x50, 0x76, 0x34, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f,
	0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x30,
	0x0a, 0x06, 0x49, 0x43, 0x4d, 0x50, 0x76, 0x36, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x2a, 0x0a, 0x07, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x66,
	0x6c, 0x6f, 0x77, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x07,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x05, 0x4b, 0x61, 0x66, 0x6b,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x61, 0x70, 0x69, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x69, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x61, 0x70, 0x69, 0x4b, 0x65, 0x79, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f,
	...
	0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x22, 0x3b, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	,
	...
	0x4f, 0x43, 0x4f, 0x4c, 0x10, 0xb4, 0x01, 0x2a, 0x4a, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x66, 0x66,
	...
	0x53, 0x10, 0x02, 0x2a, 0x39, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x0a, 0x0a, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x4c, 0x6f, 0x73, 0x74, 0x10, 0x02, 0x2a, 0x67,
	...
	0x51, 0x55, 0x45, 0x55, 0x45, 0x10, 0x02, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x69, 0x6c, 0x69, 0x75, 0x6d, 0x2f, 0x63, 0x69, 0x6c,
	0x69, 0x75, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x66, 0x6c, 0x6f, 0x77, 0x62,
...
var file_flow_flow_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_flow_flow_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_flow_flow_proto_goTypes = []interface{}{
	...
	(EventType)(0),              // 7: flow.EventType
	(LostEventSource)(0),        // 8: flow.LostEventSource
	(*Flow)(nil),                // 9: flow.Flow
	(*Layer4)(nil),              // 10: flow.Layer4
	(*Layer7)(nil),              // 11: flow.Layer7
	(*Endpoint)(nil),            // 12: flow.Endpoint
	(*TCP)(nil),                 // 13: flow.TCP
	(*IP)(nil),                  // 14: flow.IP
	(*Ethernet)(nil),            // 15: flow.Ethernet
	(*TCPFlags)(nil),            // 16: flow.TCPFlags
	(*UDP)(nil),                 // 17: flow.UDP
	(*ICMPv4)(nil),              // 18: flow.ICMPv4
	(*ICMPv6)(nil),              // 19: flow.ICMPv6
	(*EventTypeFilter)(nil),     // 20: flow.EventTypeFilter
	(*CiliumEventType)(nil),     // 21: flow.CiliumEventType
	(*FlowFilter)(nil),          // 22: flow.FlowFilter
	(*Payload)(nil),             // 23: flow.Payload
	(*DNS)(nil),                 // 24: flow.DNS
	(*HTTPHeader)(nil),          // 25: flow.HTTPHeader
	(*HTTP)(nil),                // 26: flow.HTTP
	(*Kafka)(nil),               // 27: flow.Kafka
	(*Service)(nil),             // 28: flow.Service
	(*LostEvent)(nil),           // 29: flow.LostEvent
...
var file_flow_flow_proto_depIdxs = []int32{
	30, // 0: flow.Flow.time:type_name -> google.protobuf.Timestamp
	4,  // 1: flow.Flow.verdict:type_name -> flow.Verdict
	15, // 2: flow.Flow.ethernet:type_name -> flow.Ethernet
	14, // 3: flow.Flow.IP:type_name -> flow.IP
	10, // 4: flow.Flow.l4:type_name -> flow.Layer4
	12, // 5: flow.Flow.source:type_name -> flow.Endpoint
	12, // 6: flow.Flow.destination:type_name -> flow.Endpoint
	0,  // 7: flow.Flow.Type:type_name -> flow.FlowType
	11, // 8: flow.Flow.l7:type_name -> flow.Layer7
	21, // 9: flow.Flow.event_type:type_name -> flow.CiliumEventType
	28, // 10: flow.Flow.source_service:type_name -> flow.Service
	28, // 11: flow.Flow.destination_service:type_name -> flow.Service
	...
	13, // 15: flow.Layer4.TCP:type_name -> flow.TCP
	17, // 16: flow.Layer4.UDP:type_name -> flow.UDP
	18, // 17: flow.Layer4.ICMPv4:type_name -> flow.ICMPv4
	19, // 18: flow.Layer4.ICMPv6:type_name -> flow.ICMPv6
	2,  // 19: flow.Layer7.type:type_name -> flow.L7FlowType
	24, // 20: flow.Layer7.dns:type_name -> flow.DNS
	26, // 21: flow.Layer7.http:type_name -> flow.HTTP
	27, // 22: flow.Layer7.kafka:type_name -> flow.Kafka
	16, // 23: flow.TCP.flags:type_name -> flow.TCPFlags
	3,  // 24: flow.IP.ipVersion:type_name -> flow.IPVersion
	4,  // 25: flow.FlowFilter.verdict:type_name -> flow.Verdict
	20, // 26: flow.FlowFilter.event_type:type_name -> flow.EventTypeFilter
	7,  // 27: flow.Payload.type:type_name -> flow.EventType
	30, // 28: flow.Payload.time:type_name -> google.protobuf.Timestamp
	25, // 29: flow.HTTP.headers:type_name -> flow.HTTPHeader
	8,  // 30: flow.LostEvent.source:type_name -> flow.LostEventSource
	31, // 31: flow.LostEvent.cpu:type_name -> google.protobuf.Int32Value
